// $Header: /usr/people/mbwall/src/galib/ga/RCS/gaconfig.h,v 1.4 1998/11/11 20:31:56 mbwall Exp $
/* ----------------------------------------------------------------------------
  config.h
  mbwall 27jun95
...
below for the pre-defined sets.
   ...
   NO_CPP_CASTS       If your compiler does not support RTTI, or if you turn
                      off the RTTI abilities of your compiler, then define this
                      macro.  The result is that if improper casts are made,
...
// for g++ 2.6.3 - 2.8.x
// if you use 2.8.x then you might want to comment out the NO_CPP_CASTS macro
...
// SGI DCC on irix 5.3 and irix 6.x
#if defined(__sgi)
#define NO_CPP_CASTS
#endif
